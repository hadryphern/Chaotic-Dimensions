...
namespace ChaoticDimensions.Common.OreSpawn
{
	internal static class OreSpawnMobCatalog
	{
		...
		public static readonly OreSpawnMobDefinition WaterDragon = Flyer("WaterDragon", "Water Dragon", OreSpawnSpawnKind.Ocean, ChaoticProgressionGate.PostEyeOfCthulhu, 56, 56, 24, 8, 260, 0.08f, notes: "Shoots waterballs and fireballs.") with {
			Drops = new[] {
				new OreSpawnDropDefinition(() => ModContent.ItemType<WaterDragonScale>(), 1, 2, 4),
				new OreSpawnDropDefinition(() => ModContent.ItemType<Salt>(), 2, 1, 3)
			}
		};
		public static readonly OreSpawnMobDefinition Mantis = Walker("Mantis", "Mantis", OreSpawnSpawnKind.ForestOrJungleDay, ChaoticProgressionGate.PostEyeOfCthulhu, 48, 48, 28, 10, 220, 0.09f, aiType: NPCID.Hornet, notes: "Fast predatory insect.") with {
			Drops = new[] {
				new OreSpawnDropDefinition(() => ModContent.ItemType<MantisClaw>(), 8, 1, 1)
			}
		};
		public static readonly OreSpawnMobDefinition EmperorScorpion = Walker("EmperorScorpion", "Emperor Scorpion", OreSpawnSpawnKind.DesertDay, ChaoticProgressionGate.PostEvilBoss, 64, 64, 42, 16, 1200, 0.03f, true, BuffID.Poisoned, 240, NPCID.DesertGhoulCorruption, "Desert miniboss.") with {
			Drops = new[] {
				new OreSpawnDropDefinition(() => ModContent.ItemType<EmperorScorpionScale>(), 1, 4, 8),
				new OreSpawnDropDefinition(() => ModContent.ItemType<Salt>(), 1, 3, 6)
			}
		};
		public static readonly OreSpawnMobDefinition Hercules = Walker("Hercules", "Hercules", OreSpawnSpawnKind.DesertDay, ChaoticProgressionGate.PostQueenBee, 56, 56, 48, 18, 1500, 0.02f, true, aiType: NPCID.GiantTortoise, notes: "Launches players high.") with {
			Drops = new[] {
				new OreSpawnDropDefinition(() => ModContent.ItemType<BigHammer>(), 4, 1, 1),
				new OreSpawnDropDefinition(() => ModContent.ItemType<TitaniumNugget>(), 1, 3, 6)
			}
		};
		public static readonly OreSpawnMobDefinition Caterkiller = Walker("Caterkiller", "Caterkiller", OreSpawnSpawnKind.ForestNight, ChaoticProgressionGate.PostQueenBee, 64, 48, 40, 14, 1100, 0.025f, true, aiType: NPCID.DevourerHead, notes: "Segmented bug miniboss.") with {
			Drops = new[] {
				new OreSpawnDropDefinition(() => ModContent.ItemType<CaterkillerJaw>(), 1, 2, 4)
			}
		};
		public static readonly OreSpawnMobDefinition Cephadrome = Flyer("Cephadrome", "Cephadrome", OreSpawnSpawnKind.SnowSurface, ChaoticProgressionGate.PostAnyMech, 56, 56, 58, 20, 2200, 0.015f, true, notes: "Ice flyer and Kraken counter.") with {
			Drops = new[] {
				new OreSpawnDropDefinition(() => ModContent.ItemType<CephadromeHorn>(), 1, 1, 2),
				new OreSpawnDropDefinition(() => ModContent.ItemType<Kyanite>(), 1, 2, 5)
			}
		};
		public static readonly OreSpawnMobDefinition Alien = Walker("Alien", "Alien", OreSpawnSpawnKind.Sky, ChaoticProgressionGate.PostAnyMech, 54, 60, 62, 22, 2600, 0.01f, true, aiType: NPCID.MartianWalker, notes: "High-tech invader.") with {
			Drops = new[] {
				new OreSpawnDropDefinition(() => ModContent.ItemType<UraniumOre>(), 1, 5, 10),
				new OreSpawnDropDefinition(() => ModContent.ItemType<RayGun>(), 16, 1, 1)
			}
		};
		...
		public static readonly OreSpawnMobDefinition Basilisc = Walker("Basilisc", "Basilisc", OreSpawnSpawnKind.DesertNight, ChaoticProgressionGate.PostQueenBee, 52, 40, 36, 12, 800, 0.03f, true, aiType: NPCID.Antlion, notes: "Heavy desert predator.") with {
			Drops = new[] {
				new OreSpawnDropDefinition(() => ModContent.ItemType<Ruby>(), 1, 2, 5)
			}
		};
		...
		public static readonly OreSpawnMobDefinition CaveFisher = Walker("CaveFisher", "Cave Fisher", OreSpawnSpawnKind.Cavern, ChaoticProgressionGate.PostSkeletron, 40, 36, 30, 10, 260, 0.025f, aiType: NPCID.CaveBat, notes: "Underground ambusher.") with {
			Drops = new[] {
				new OreSpawnDropDefinition(() => ModContent.ItemType<TitaniumOre>(), 1, 2, 5)
			}
		};
		public static readonly OreSpawnMobDefinition CreepingHorror = Walker("CreepingHorror", "Creeping Horror", OreSpawnSpawnKind.CorruptNight, ChaoticProgressionGate.PostAnyMech, 48, 40, 46, 14, 900, 0.02f, true, aiType: NPCID.Corruptor, notes: "Corruption horror.") with {
			Drops = new[] {
				new OreSpawnDropDefinition(() => ModContent.ItemType<UraniumOre>(), 1, 2, 5)
			}
		};
		public static readonly OreSpawnMobDefinition CrystalUrchin = Walker("CrystalUrchin", "Crystal Urchin", OreSpawnSpawnKind.HallowNight, ChaoticProgressionGate.PostPlantera, 36, 34, 38, 18, 700, 0.02f, aiType: NPCID.Gastropod, notes: "Spiked crystal creature.") with {
			Drops = new[] {
				new OreSpawnDropDefinition(() => ModContent.ItemType<Kyanite>(), 1, 2, 6)
			}
		};
		...
		public static readonly OreSpawnMobDefinition DungeonBeast = Walker("DungeonBeast", "Dungeon Beast", OreSpawnSpawnKind.Dungeon, ChaoticProgressionGate.PostPlantera, 60, 52, 56, 20, 2200, 0.015f, true, aiType: NPCID.Paladin, notes: "Dungeon heavy.") with {
			Drops = new[] {
				new OreSpawnDropDefinition(() => ModContent.ItemType<RatCrystal>(), 1, 1, 3),
				new OreSpawnDropDefinition(() => ModContent.ItemType<FairyCrystal>(), 2, 1, 2)
			}
		};
		...
		public static readonly OreSpawnMobDefinition Molenoid = Burrower("Molenoid", "Molenoid", OreSpawnSpawnKind.Underground, ChaoticProgressionGate.PostEvilBoss, 36, 32, 22, 6, 180, 0.04f, false, "Digging mole-creature.") with {
			Drops = new[] {
				new OreSpawnDropDefinition(() => ModContent.ItemType<MolenoidDirt>(), 1, 6, 14)
			}
		};
		...
		public static readonly OreSpawnMobDefinition Rotator = Flyer("Rotator", "Rotator", OreSpawnSpawnKind.Cavern, ChaoticProgressionGate.PostAnyMech, 42, 42, 40, 12, 820, 0.025f, notes: "Spinning underground flyer.") with {
			Drops = new[] {
				new OreSpawnDropDefinition(() => ModContent.ItemType<Kyanite>(), 1, 1, 4)
			}
		};
		...
		public static readonly OreSpawnMobDefinition TerribleTerror = Flyer("TerribleTerror", "Terrible Terror", OreSpawnSpawnKind.Underworld, ChaoticProgressionGate.PostAnyMech, 48, 44, 54, 18, 1500, 0.02f, true, notes: "Late fiery terror.") with {
			Drops = new[] {
				new OreSpawnDropDefinition(() => ModContent.ItemType<UraniumOre>(), 1, 3, 7),
				new OreSpawnDropDefinition(() => ModContent.ItemType<LavaFoam>(), 2, 1, 3)
			}
		};
		...
		public static readonly OreSpawnMobDefinition Vortex = Flyer("Vortex", "Vortex", OreSpawnSpawnKind.Sky, ChaoticProgressionGate.PostCultist, 52, 52, 74, 24, 3200, 0.015f, true, notes: "Late celestial flyer.") with {
			Drops = new[] {
				new OreSpawnDropDefinition(() => ModContent.ItemType<Kyanite>(), 1, 4, 8),
				new OreSpawnDropDefinition(() => ModContent.ItemType<UraniumOre>(), 2, 2, 5)
			}
		};
		...
		public static readonly OreSpawnMobDefinition CloudShark = Flyer("CloudShark", "Cloud Shark", OreSpawnSpawnKind.Sky, ChaoticProgressionGate.PostWallOfFlesh, 44, 32, 32, 10, 420, 0.03f, notes: "Sky predator.") with {
			Drops = new[] {
				new OreSpawnDropDefinition(() => ModContent.ItemType<TitaniumOre>(), 1, 2, 5)
			}
		};
		...
		public static readonly OreSpawnMobDefinition Fairy = Flyer("Fairy", "Fairy", OreSpawnSpawnKind.HallowNight, ChaoticProgressionGate.PostEvilBoss, 28, 30, 12, 4, 80, 0.03f, notes: "Small magic flyer.") with {
			Drops = new[] {
				new OreSpawnDropDefinition(() => ModContent.ItemType<FairyCrystal>(), 1, 1, 2),
				new OreSpawnDropDefinition(() => ModContent.ItemType<FairySword>(), 25, 1, 1)
			}
		};
		...
		public static readonly OreSpawnMobDefinition Rat = Ambient("Rat", "Rat", OreSpawnSpawnKind.ForestNight, 20, 14, 8, 1, 24, NPCID.Mouse, "Small rat.") with {
			Drops = new[] {
				new OreSpawnDropDefinition(() => ModContent.ItemType<RatCrystal>(), 1, 1, 2),
				new OreSpawnDropDefinition(() => ModContent.ItemType<RatSword>(), 20, 1, 1)
			}
		};
