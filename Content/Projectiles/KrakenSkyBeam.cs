	...
	public class KrakenSkyBeam : ModProjectile
	{
		...
		public override void AI() {
			...
			if (Projectile.ai[0] == TelegraphTime) {
				...
				KrakenEventSystem.Instance.AddShake(12, 10f);
			}
		...
		public override bool PreDraw(ref Color lightColor) {
			...
			if (!Striking) {
				Color warning = new Color(120, 190, 255, (byte)(36 + 54 * telegraphProgress));
				...
				Main.spriteBatch.Draw(texture, drawPosition, source, new Color(30, 90, 190, (byte)(28 * telegraphProgress)), BeamRotation, origin, new Vector2(0.26f, lengthScale), SpriteEffects.None, 0f);
				return false;
			}

			float pulse = 0.94f + 0.12f * (float)System.Math.Sin(Main.GlobalTimeWrappedHourly * 28f);
			Color outer = new Color(58, 155, 255, (byte)(78 * strikeFade));
			Color inner = new Color(235, 252, 255, (byte)(150 * strikeFade));
