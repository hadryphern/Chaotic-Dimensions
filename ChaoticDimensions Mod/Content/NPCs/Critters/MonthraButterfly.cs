// Implementa a IA, animacao e regras dos NPCs de Monthra Butterfly.
...
namespace ChaoticDimensions.Content.NPCs.Critters
{
	public sealed class MonthraButterfly : ModNPC
	{
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo) {
			if (!NPC.downedMoonlord || spawnInfo.PlayerSafe || spawnInfo.Invasion || NPC.AnyNPCs(ModContent.NPCType<MonthraBoss>())) {
				return 0f;
			}
