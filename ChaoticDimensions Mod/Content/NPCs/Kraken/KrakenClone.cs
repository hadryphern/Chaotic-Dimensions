// Implementa a IA, animacao e regras dos NPCs de Kraken Clone.
...
namespace ChaoticDimensions.Content.NPCs.Kraken
{
	public class KrakenClone : ModNPC
	{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor) {
			...
			spriteBatch.Draw(texture, center, source, new Color(26, 34, 70) * 0.42f, NPC.rotation, origin, scale, SpriteEffects.None, 0f);
			return false;
		}
