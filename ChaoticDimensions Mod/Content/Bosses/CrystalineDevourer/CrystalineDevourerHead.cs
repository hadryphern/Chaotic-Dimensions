// Controla os dois vermes, a vida partilhada e os ataques do Crystaline Devourer.
...
namespace ChaoticDimensions.Content.Bosses.CrystalineDevourer
{
	...
	public sealed class CrystalineDevourerHead : ModNPC
	{
		...
		// Executa a logica principal antes da IA padrao do Terraria.
		...
		// Define o verme lider e prepara a arena partilhada.
		...
		// Cria os segmentos ligados que formam o corpo.
		...
		// Cria o segundo verme e liga a sua vida ao lider.
		...
		// Mantem os dois vermes com a mesma proporcao de vida.
		...
		// Escolhe entre orbita, dash e laser supremo.
		...
		// Remove NPCs, projecteis e arena sem jogadores validos.
		...
		// Controla a frequencia dos shards.
		...
		// Ajusta o dano recebido antes de o aplicar.
