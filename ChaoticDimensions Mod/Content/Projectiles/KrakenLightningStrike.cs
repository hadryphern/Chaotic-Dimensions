...
namespace ChaoticDimensions.Content.Projectiles
{
	...
	{
		private const int TelegraphTime = 58;
		private const int StrikeTime = 9;
		...
		public override bool PreDraw(ref Color lightColor) {
			...
			if (!striking) {
				...
				if (!VisualOnly) {
					spriteBatchSafeDraw(pixel, new Rectangle((int)(centerX - 12f), (int)top, 1, (int)visibleHeight), new Color(78, 105, 138, 20));
					spriteBatchSafeDraw(pixel, new Rectangle((int)(centerX + 12f), (int)top, 1, (int)visibleHeight), new Color(78, 105, 138, 20));
				}
				return false;
			}
			...
			Color outer = new Color(105, 160, 195, (byte)(VisualOnly ? 74 * flicker : 112 * flicker));
			Color inner = new Color(242, 249, 252, (byte)(VisualOnly ? 96 * flicker : 176 * flicker));
			Main.spriteBatch.Draw(lightning, position + new Vector2(-jitter * 0.75f, 0f), null, new Color(48, 90, 138, (byte)(48 * flicker)), 0f, origin, scale * new Vector2(1.5f, 1f), SpriteEffects.FlipHorizontally, 0f);
