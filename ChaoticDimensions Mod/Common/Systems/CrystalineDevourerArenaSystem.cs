// Cria a arena temporaria do Crystaline e restaura os tiles no final.
...
namespace ChaoticDimensions.Common.Systems
{
	public sealed class CrystalineDevourerArenaSystem : ModSystem
	{
		...
		// Calcula o centro e guarda os tiles que serao substituidos.
		...
		// Inicia a limpeza segura quando o encontro termina.
		...
		// Aplica a regra de limite aos participantes vivos.
		...
		// Constroi o limite temporario em redor dos jogadores.
		...
		// Repoe exatamente os tiles guardados antes da luta.
