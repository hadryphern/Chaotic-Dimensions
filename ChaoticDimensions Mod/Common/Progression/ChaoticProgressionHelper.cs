// Centraliza as verificacoes de progressao usadas por itens, NPCs e receitas.
	...
	public static class ChaoticProgressionHelper
	{
		public static bool IsMet(ChaoticProgressionGate gate) {
			return gate switch {
				...
				ChaoticProgressionGate.PostMonthra => ChaoticDownedBossSystem.downedMonthra,
				ChaoticProgressionGate.PostCrystalineDevourer => ChaoticDownedBossSystem.downedCrystalineDevourer,
				ChaoticProgressionGate.PostKraken => ChaoticDownedBossSystem.downedKraken,
		...
		public static string GetDebugLabel(ChaoticProgressionGate gate) {
			return gate switch {
				...
				ChaoticProgressionGate.PostMonthra => "Post Monthra",
				ChaoticProgressionGate.PostCrystalineDevourer => "Post Crystaline Devourer",
				ChaoticProgressionGate.PostKraken => "Post Alien Kraken",
